...
reframed = series_to_supervised(scaled, N_DAYS, 2)
# drop columns we don't want to predict
reframed.drop(reframed.columns[[25, 26, 27, 28, 29, 30, 31, 33, 34]], axis=1, inplace=True)
...
model.save('models/tomorrow_model-' + CITY + '.h5')
# make a prediction
